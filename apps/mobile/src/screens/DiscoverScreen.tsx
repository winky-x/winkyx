    ...
    return (
        <SafeAreaView className="flex-1 bg-background">
            ...
            <StyledView className="flex-1 items-center justify-center">
                <StyledText className="text-foreground text-lg">Discover Screen</StyledText>
                <StyledText className="text-muted-foreground mt-2">Live peer discovery UI will be here.</StyledText>
            </StyledView>
        </SafeAreaView>
    );
}
